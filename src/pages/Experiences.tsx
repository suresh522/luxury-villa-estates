  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="keywords" content="luxury experiences Chirala, pool villas activities Andhra Pradesh, sunset cruise, cultural tours, beach bonfire, curated experiences pool villas India" />
